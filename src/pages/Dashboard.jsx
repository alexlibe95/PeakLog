          ...
          <>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  View your attendance record and current status
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {nextTrainingSession ? (
                    <div className="p-4 bg-muted/50 rounded-lg">
                      <h4 className="font-semibold mb-2">Next Session Status</h4>
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-sm">
                            <span className="font-medium">{nextTrainingSession.programName}</span>
                            <span className="text-muted-foreground"> on {nextTrainingSession.day}</span>
                          </p>
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      {athleteAttendanceHistory.length > 0 ? (
                        athleteAttendanceHistory.slice(0, 5).map((record, index) => (
                          <div key={record.sessionId || index} className="flex items-center justify-between p-2 bg-muted/30 rounded">
                            <div>
                              <span className="text-sm font-medium">{record.sessionName}</span>
                              <span className="text-xs text-muted-foreground ml-2">
                                {record.date ? new Date(record.date).toLocaleDateString() : 'Recent'}
                              </span>
                            </div>
                            <Badge
                              variant="outline"
                        ...
                        <div className="text-center py-4">
                          ...
                          <p className="text-xs text-muted-foreground">Your attendance will appear here after training sessions</p>
                        </div>
                      )}
                    </div>
                  </div>
